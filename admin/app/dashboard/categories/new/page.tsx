    ...
    return (
        <div className="max-w-4xl">
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Add New Category</h1>
                <p className="text-gray-600 dark:text-gray-400">Create a new category for your products</p>
            </div>
