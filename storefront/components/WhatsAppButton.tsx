...
const WhatsAppButton = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-24 right-6 z-[9999] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 group flex items-center gap-2"
